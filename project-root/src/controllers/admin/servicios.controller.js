...
module.exports = {
  list: async (req,res) => res.render('layouts/admin',{view:'../admin/servicios/list',data:await repo.findAll()}),
  createForm: (req,res) => res.render('layouts/admin',{view:'../admin/servicios/create'}),
  create: async (req,res) => {await repo.create(req.body);res.redirect('/admin/servicios')},
  editForm: async (req,res) => res.render('layouts/admin',{view:'../admin/servicios/edit',data:await repo.findById(req.params.id)}),
