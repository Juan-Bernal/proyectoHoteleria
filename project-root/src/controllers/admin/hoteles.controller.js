...
module.exports = {
  list: async (req,res) => res.render('layouts/admin',{view:'../admin/hoteles/list',data:await repo.findAll()}),
  createForm: (req,res) => res.render('layouts/admin',{view:'../admin/hoteles/create'}),
  create: async (req,res) => {await repo.create(req.body);res.redirect('/admin/hoteles')},
  editForm: async (req,res) => res.render('layouts/admin',{view:'../admin/hoteles/edit',data:await repo.findById(req.params.id)}),
